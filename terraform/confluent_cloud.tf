...
#   kafka_cluster {
#     id = confluent_kafka_cluster.example_dedicated_cluster.id
#   }
#   topic_name         = var.ccloud_cluster_topic
#   rest_endpoint      = confluent_kafka_cluster.example_dedicated_cluster.rest_endpoint
#   partitions_count = 1
#   credentials {
...
#   managed_resource {
#     id          = confluent_kafka_cluster.example_dedicated_cluster.id
#     api_version = confluent_kafka_cluster.example_dedicated_cluster.api_version
#     kind        = confluent_kafka_cluster.example_dedicated_cluster.kind
...
#   crn_pattern = confluent_kafka_cluster.example_dedicated_cluster.rbac_crn
#   lifecycle {
#     prevent_destroy = false
#   }
# }
...
#   crn_pattern = "${confluent_kafka_cluster.example_dedicated_cluster.rbac_crn}/kafka=${confluent_kafka_cluster.example_dedicated_cluster.id}/topic=${confluent_kafka_topic.example_dedicated_topic_test.topic_name}"
#   lifecycle {
#     prevent_destroy = false
#   }
# }
# resource "confluent_kafka_acl" "example_dedicated_acl_producer" {
...
#   rest_endpoint  = confluent_kafka_cluster.example_dedicated_cluster.rest_endpoint
#   resource_type = "TOPIC"
#   resource_name = confluent_kafka_topic.example_dedicated_topic_test.topic_name
...
#   principal   = "User:${confluent_service_account.example_dedicated_sa_consumer.id}"
#   role_name   = "DeveloperRead"
#   crn_pattern = "${confluent_kafka_cluster.example_dedicated_cluster.rbac_crn}/kafka=${confluent_kafka_cluster.example_dedicated_cluster.id}/group=${var.ccloud_cluster_consumer_group_prefix}*"
#   lifecycle {
#     prevent_destroy = false
#   }
# }

# resource "confluent_kafka_acl" "example_dedicated_acl_consumer" {
#   # Instaniciate this block only if the cluster type IS basic
#   count = var.ccloud_cluster_type=="basic" ? 1 : 0
...
# resource "confluent_kafka_acl" "example_dedicated_acl_consumer_group" {
#   # Instaniciate this block only if the cluster type IS basic
#   count = var.ccloud_cluster_type=="basic" ? 1 : 0
...
#    value = confluent_kafka_cluster.example_dedicated_cluster.bootstrap_endpoint
# }
# output "cluster_rest_endpoint" {
#     value = confluent_kafka_cluster.example_dedicated_cluster.rest_endpoint
# }
...
#     cluster_bootstrap_server = trimprefix("${confluent_kafka_cluster.example_dedicated_cluster.bootstrap_endpoint}", "SASL_SSL://")
